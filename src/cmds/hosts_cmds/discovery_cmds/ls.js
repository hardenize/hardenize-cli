...
exports.builder = function(yargs) {
    ...
    yargs.option('resolution',       { type: 'string',  description: 'Return only discoveries with this resolution'  });
...
exports.handler = function ls_host_discoveries_handler(argv) {
    ...
    var opt = ['discoveredSince', 'limit', 'resolution', 'matchLocation', 'matchReason']
