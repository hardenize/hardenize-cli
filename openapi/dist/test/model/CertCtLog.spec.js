...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HardenizeOrgApi.CertCtLog();
  });
  ...
  describe('CertCtLog', function() {
    it('should create an instance of CertCtLog', function() {
      // uncomment below and update the code to test CertCtLog
      //var instance = new HardenizeOrgApi.CertCtLog();
      //expect(instance).to.be.a(HardenizeOrgApi.CertCtLog);
    });
