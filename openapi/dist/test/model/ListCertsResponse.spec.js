...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HardenizeOrgApi.ListCertsResponse();
  });
  ...
  describe('ListCertsResponse', function() {
    it('should create an instance of ListCertsResponse', function() {
      // uncomment below and update the code to test ListCertsResponse
      //var instance = new HardenizeOrgApi.ListCertsResponse();
      //expect(instance).to.be.a(HardenizeOrgApi.ListCertsResponse);
    });
