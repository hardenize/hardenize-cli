...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HardenizeOrgApi.CertificatesApi();
  });
  ...
  describe('CertificatesApi', function() {
    describe('createACertificate', function() {
      it('should call createACertificate successfully', function(done) {
        //uncomment below and update the code to test createACertificate
        //instance.createACertificate(function(error) {
    ...
    describe('retrieveACertificate', function() {
      it('should call retrieveACertificate successfully', function(done) {
        //uncomment below and update the code to test retrieveACertificate
        //instance.retrieveACertificate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
