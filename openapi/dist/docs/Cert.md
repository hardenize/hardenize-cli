...
**keyAlg** | **String** | Private key algorithm, for example RSA or EC. | [optional] 
**keyLen** | **Number** | Private key length, for example 256 for an ECDSA key or 2048 for an RSA key. | [optional] 
**keyStrength** | **Number** | Estimated private key strength in symmetric bits. For example, a 256-bit ECDSA key is thought to provide 128 bits of security, whereas a 2048-bit RSA key provides about 112.  | [optional] 
**sigAlg** | **String** | Certificate signature algorithm. | [optional] 
**spkiSha256** | **String** | Hex-encoded SHA256 of the certificate&#39;s SPKI component | [optional] 
...
**caPathLen** | **Number** | Indicates if this is a CA certificate. Leaf certificates will have -1 in this field, indicating that they cannot issue further certificates. CA certificates will have 0 or a positive number. CA certificates without path length limit will have 2,147,483,647.  | [optional] 
**wildcard** | **Boolean** | Set to true if the hostname list contains at least one wildcard. | [optional] 
**selfSigned** | **Boolean** | Set to true if this is a self-signed certificate. | [optional] 
...
**seenInstalled** | **Boolean** | Indicates if this certificate has been seen installed on a server | [optional] 
**precert** | **Boolean** | Indicates if the returned certificate is, in fact, a precertificate. | 
**managed** | **Boolean** | Indicates if this certificate is managed, i.e. provided by a third-party service that will also automatically renew the certificate when it becomes due.  | [optional] 
**ownership** | **String** | Indicates if this certificate belongs to the organisation, which means that it is served from one of the organization&#39;s properties. Do note that, in the case of certificate name mismatch, someone else&#39;s certificate may be considered as own. In that case, the **matchesOrgHost** field will be set to false.  | [optional] 
**matchesOrgHost** | **Boolean** | Indicates if at least one of the host listed in the certificates matches a hosts that belongs to the organisation.  | [optional] 
**symantecStatus** | **String** | Indicates if this certificate was issued from Symantec&#39;s PKI infrastructure.  | [optional] 
...
**ctLogs** | [**[CertCtLog]**](CertCtLog.md) |  | [optional] 
