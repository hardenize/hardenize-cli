...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HardenizeOrgApi.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://www.hardenize.com/org/{orgLabel}/api/v0
     */
    this.basePath = 'https://www.hardenize.com/org/{orgLabel}/api/v0'.replace(/\/+$/, '');
    ...
    this.authentications = {
      'Basic HTTP Authentication': {type: 'basic'}
    };
    /**
    ...
    switch (type) {
      ...
      default:
        if (type === Object) {
          ...
          return data;
        } else if (typeof type === 'function' && type.constructFromObject) {
